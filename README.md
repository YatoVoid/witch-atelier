...
- `js/data/signatures.js`: recognizes a drawn spell as a named spellbook entry, but only for the five whose actual sign composition is confirmed: Grasping Wind and Sylph Shoes Seal from the wiki; Light Beam, Watershot Seal, and Rising Wave read directly off their reference art (Light Beam is a light sigil with four Column signs at the cardinal points; Watershot Seal and Rising Wave are both a water sigil with eight Column-family signs spaced evenly around the ring, and read identically since there's no shape difference between them in the art either). All 40 spellbook images were surveyed for this; the other 35 either use a motif outside the 8 sigils and 24 signs (faces, eyes, elaborate borders) or weren't legible enough to be confident about, so there's nothing honest to match against for them. Faking a match would be worse than not detecting them.
